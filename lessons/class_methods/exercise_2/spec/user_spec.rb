...
RSpec.describe User do
  ...
  it "can create multiple users" do
    ...
    ## Can you call User.create_multiple(users) in pry? What does it return?
    # Yes. An array of users.
    ...
    ##What is created_users in pry? What type is the first index? Can you access any properties on it?
    # An array of users
    # User
    # Yes
